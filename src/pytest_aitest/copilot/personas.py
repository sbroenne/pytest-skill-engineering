"""IDE Personas for pytest-aitest Copilot support.
...
Usage::
    ...
    from pytest_aitest.copilot import CopilotAgent, VSCodePersona, ClaudeCodePersona
...
def _make_subagent_dispatch_tool(
    ...
    from pytest_aitest.copilot.agent import CopilotAgent as _CopilotAgent
