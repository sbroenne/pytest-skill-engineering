...
You are analyzing test results for **pytest-codingagents**, a skill engineering framework that tests coding agents (like GitHub Copilot) via their native SDKs. It validates whether agents can discover and orchestrate skills — tools, instructions, domain knowledge, and custom agents — to complete real-world tasks.
