...
from pytest_skill_engineering.reporting.components.types import (
    AgentData,
    ReportContext,
    ReportMetadata,
    TestData,
...
def _footer(timestamp: str) -> str:
    ...
    return (
        f"*Generated by [pytest-skill-engineering]"
        f"(https://github.com/sbroenne/pytest-skill-engineering) "
        f"on {timestamp}*\n"
    )
